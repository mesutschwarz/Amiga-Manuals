...
### AUTOPUSH
This switch option enables the automatic **pushcd** command for every change in the current directory, whether made by the built-in **cd** command or an implicit ed.
